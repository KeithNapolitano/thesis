    ...
    <body>
            ...
            <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"></a><img
                ...
                <div class="collapse navbar-collapse" id="navcol-2">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="opview"><span
                                    style="color: rgb(0, 0, 0);">Operator View</span></a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    ...
                    <p class="text-muted w-lg-50" style="font-size: 16px;">Listed below are all vans available during
                        this day</p>
                </div>
                            ...
                            <div class="border rounded border-5 horitzontalScrollContent me-3">
                                <div class="row">
                                    <div class="col text-center">
                                        <p id="bigdate-6" style="font-size: 30px;font-weight: bold;margin: 0px;">21</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col text-center">
        ...
        <div class="container">
            <div class="card-group">
                <div class="card">
                    <div class="card-body" style="padding: 16px;">
                        ...
                        <ul class="list-group" style="padding: 0;padding-bottom: 10px;">
                            ...
                            <li class="list-group-item"><span>Driver: Mr. Meowmeow</span></li>
                        </ul><a class="btn btn-primary" role="button" href="opview">Van View</a>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body" style="padding: 16px;">
                        <h4 class="fs-5 card-title" style="font-size: 26px;margin-bottom: 0px;"><strong>Toyota
                                HiAce&nbsp;
                            </strong><br><strong>CMSC 199</strong><br><span></span></h4>
                        <p class="fs-6 card-text" style="margin-bottom: 8px;">Davao City to Digos City</p>
                        <ul class="list-group" style="padding: 0;padding-bottom: 10px;">
                            <li class="list-group-item"><span>5 Seats available</span></li>
                            <li class="list-group-item"><span>4 paid&nbsp;
                                </span></li>
                ...
                <div class="card">
                    <div class="card-body" style="padding: 16px;">
                        <h1 class="fs-5 card-title" style="font-size: 26px;margin-bottom: 0px;"><strong>Toyota
                                HiAce&nbsp;
                            </strong><br><strong>KPY 210</strong><span></span></h1>
                        <p class="fs-6 card-text" style="margin-bottom: 8px;">Davao City to Koronadal City</p>
                        <ul class="list-group" style="padding: 0;padding-bottom: 10px;">
                            <li class="list-group-item"><span>5 Seats available</span></li>
                            <li class="list-group-item"><span>4 paid&nbsp;
                                </span></li>
