...
<body style="background: rgb(205,220,235);">
    <nav class="navbar navbar-light navbar-expand-xxl sticky-top bg-white"
        ...
        <div class="container-fluid"><a class="navbar-brand text-end" href="index" style="height: 50px;"><img
                    src="{{asset('import_admin/assets/img/logo.png')}}" style="width: 100px;"></a><button
                data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"
                style="height: 40px;width: 45px;"><span class="visually-hidden">Toggle navigation</span><span
                    class="navbar-toggler-icon" style="width: 19px;height: 13px;"></span></button>
            <div class="collapse navbar-collapse text-center" id="navcol-1"
                style="margin: 22px;width: 356px;height: 100;">
    ...
    <div>
        <div class="container text-center text-sm-center text-md-center text-lg-center text-xl-center text-xxl-center"
            style="background: rgba(255,228,196,0);">
            ...
            <div class="card-group text-center" style="height: 100%;">
                <div class="card" style="border-style: none;margin: 10px;background: rgba(255,255,255,0);">
                    <div class="card-body"
                        style="border: 3px solid rgb(12,37,126);border-radius: 15px;box-shadow: -3px 3px;width: 100%;">
                        <h4 class="card-title">Add Destination</h4>
                        <div class="row">
                            <div class="col">
                                <div><button class="btn btn-primary" type="button" data-bs-toggle="modal"
                                        data-bs-target="#modalInstrucciones" style="width: 100%;"> <svg
    ...
    <div class="card text-xl-center text-xxl-center"
        ...
        <div class="card-body"
            style="border-style: solid;border-color: rgb(12,37,126);border-radius: 15px;box-shadow: -3px 3px;width: 100%;">
            <h4 class="card-title">Account</h4><a class="btn btn-primary" role="button" style="width: 100%;"
                href="account"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"
            ...
            <div>
                <ul class="nav nav-tabs" id="myTab" role="tablist" style="margin-bottom: 24px;">
                    ...
                    <li class="nav-item @if ($loop->first)
                        ...
                        <a class="nav-link" id="tab-{{ $route->id }}" data-toggle="tab"
                            data-bs-target="#tab-pane-{{ $route->id }}" href="#tab-pane-{{ $route->id }}" role="tab"
                            aria-controls="{{ $route->id }}" aria-selected="false">{{ $route->descr }}</a>
                    </li>
                    @endforeach
                </ul>
                                        ...
                                        <form method="POST" action="{{ route('trip.store') }}" class="form-custom">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="van_plate"
