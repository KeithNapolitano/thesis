...
<body>
    ...
    <nav class="navbar navbar-light navbar-expand-md fixed-top navbar-shrink py-3" id="mainNav">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="{{ route('sigo') }}"><img src="{{ asset('import/assets/img/Logo.png')}}"></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            ...
            </div><a class="btn btn-primary" type="button" href="{{ route ('register') }}">Register</a>
        </div>
    </nav>
    <section class="py-5 mt-5">
        <div class="container py-5">
            <h2 class="fw-bold text-center">Please Log in to Fully Access siGÓ </h2>
                            ...
                            <div class="bs-icon-xl bs-icon-circle bs-icon-primary shadow bs-icon my-4"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-person">
                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="email" class="form-control" type="email" placeholder="Email" name="email" :value="old('email')" required autofocus />
                                ...
                                {{-- <div class="mb-3"></div><a class="btn btn-secondary btn-sm" role="button" style="margin-top: 30px;margin-bottom: 30px;width: 149.2812px;height: 43.1719px;font-size: 17px;" href="schedule"><span style="color: rgb(0, 0, 0);">Log In</span><br></a> --}}
                                    <div class="mb-3">
                                        ...
                                        <x-primary-button class="btn btn-secondary btn-sm" style="margin-top: 30px;margin-bottom: 30px;width: 149.2812px;height: 43.1719px;font-size: 17px;">
                                            <span style="color: rgb(0, 0, 0);">{{ __('Log in') }}</span>
