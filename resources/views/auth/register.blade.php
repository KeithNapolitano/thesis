...
<body>
    ...
    <nav class="navbar navbar-light navbar-expand-md fixed-top navbar-shrink py-3" id="mainNav">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="{{ route('sigo') }}"><img src="{{ asset('import/assets/img/Logo.png')}}"></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            ...
            </div><a class="btn btn-primary" type="button" href="{{ route ('login') }}">Log in</a>
        </div>
    </nav>
    <section class="py-5 mt-5">
        <div class="container py-5">
            <h2 class="fw-bold text-center">Please Register to Fully Access siGÓ </h2>
                            ...
                            {{-- <div class="bs-icon-xl bs-icon-circle bs-icon-primary shadow bs-icon my-4"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-person">
                                ...
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="name" class="form-control" type="text" name="name" placeholder="Name" :value="old('name')" required autofocus />
                                ...
                                {{-- <div class="mb-3"><input class="form-control" type="password" name="password" placeholder="Password"></div> --}}
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="contact" class="form-control" type="text" name="contact" placeholder="Contact Number" :value="old('contact')" required />
                                        <x-input-error :messages="$errors->get('contact')"/>
                                    </div>

                                    <!-- Valid Id -->
                                    <div>
                                        <x-input-label for="validid_num" />
                                        <x-text-input id="validid_num" class="form-control" type="text" name="validid_num" placeholder="Valid ID Number" :value="old('validid_num')" required />
                                        <x-input-error :messages="$errors->get('validid_num')"/>
                                    </div>
                                    

                                    <div class="mb-3">
                                        <x-primary-button class="btn btn-secondary btn-sm" style="margin-top: 30px;margin-bottom: 30px;width: 149.2812px;height: 43.1719px;font-size: 17px;">
                                            <span style="color: rgb(0, 0, 0);">{{ __('Register') }}</span>
        ...
        <div class="container py-4 py-lg-5">
            <div class="row justify-content-center">
                <div class="col-lg-3 text-center text-lg-start d-flex flex-column align-items-center order-first align-items-lg-start order-lg-last item social">
                    ...
                    {{-- <img src="{{ asset('import/assets/img/main%20logo.png')}}"> --}}
