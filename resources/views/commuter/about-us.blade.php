        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item set-bg" data-setbg="{{ asset('import_commuter/assets/images/kit.jpg') }}">
                        <div class="bi-text">
                            <span class="b-tag">Keith Napolitano</span>
                            <!-- <h4><a href="">Back-end Developer</a></h4> -->
                            <!-- <div class="b-time"></i> Kristine Keith Napolitano</div> -->
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item set-bg" data-setbg="{{ asset('import_commuter/assets/images/mark.jpg') }}">
                        <div class="bi-text">
                            <span class="b-tag">Mark Valderrama</span>
                            <!-- <h4><a href="./blog-details.html">Back-end</a></h4> -->
                            <!-- <div class="b-time"></i> Mark Christian Valderrama</div> -->
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item set-bg" data-setbg="{{ asset('import_commuter/assets/images/chester.jpg') }}">
                        <div class="bi-text">
                            <span class="b-tag">Chester Tadle</span>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item set-bg" data-setbg="{{ asset('import_commuter/assets/images/troy.jpg') }}">
                        <div class="bi-text">
                            <span class="b-tag">Troy Martinez</span>
