                        ...
                        <div class="nav-menu">
                            <nav class="mainmenu">
                                <ul>
                                    ...
                                    <li  class="active"><a href="{{ url('/destination') }}">Destinations</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="room-item">
                    <img src="{{ asset('import_commuter/assets/img/socot.png') }}">
                        <div class="ri-text">
                            <h4 style="font-weight: 400; font-family: 'Lora', serif !important;">South Cotabato</h4>
                            <h3 style="font-weight: 400; font-family: 'Lora', serif !important;">₱ 600</h3>
                            <table>
                                <tbody>
                                    <tr>
                                        <td class="r-o">Van :</td>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="room-item">
                    <img src="{{ asset('import_commuter/assets/img/koronadal.png') }}" style = "height: 293px;">
                        <div class="ri-text">
                            <h4 style="font-weight: 400; font-family: 'Lora', serif !important;">Koronadal</h4>
                            <h3 style="font-weight: 400; font-family: 'Lora', serif !important;">₱ 400 </h3>
                            <table>
                                <tbody>
                                    <tr>
                                        <td class="r-o">Van:</td>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="room-item">
                    <img src="{{ asset('import_commuter/assets/img/gensan.png') }}" style = "height: 293px;">
                        <div class="ri-text">
                            <h4 style="font-weight: 400; font-family: 'Lora', serif !important;">General Santos City</h4>
                            <h3 style="font-weight: 400; font-family: 'Lora', serif !important;">₱ 300</h3>
                            <table>
                                <tbody>
                                    <tr>
                                        <td class="r-o">Van:</td>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="room-item">
                    <img src="{{ asset('import_commuter/assets/img/tagum.png') }}"style = "height: 293px;">
                        <div class="ri-text">
                            <h4 style="font-weight: 400; font-family: 'Lora', serif !important;">Tagum City</h4>
                            <h3 style="font-weight: 400; font-family: 'Lora', serif !important;">₱ 150</h3>
                            <table>
                                <tbody>
                                    <tr>
                                        <td class="r-o">Van:</td>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="room-item">
                    <img src="{{ asset('import_commuter/assets/img/sar.png') }}" style = "height: 293px;">
                        <div class="ri-text">
                            <h4 style="font-weight: 400; font-family: 'Lora', serif !important;">Saranggani</h4>
                            <h3 style="font-weight: 400; font-family: 'Lora', serif !important;">₱ 300 </h3>
                            <table>
                                <tbody>
                                    <tr>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="room-item">
                    <img src="{{ asset('import_commuter/assets/img/kidap.jpg') }}" style = "height: 293px;">
                        <div class="ri-text">
                            <h4 style="font-weight: 400; font-family: 'Lora', serif !important;">Kidapawan</h4>
                            <h3 style="font-weight: 400; font-family: 'Lora', serif !important;">₱ 150 </h3>
                            <table>
                                <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="r-o">E.T.A.</td>
                                        <td>2 hrs 37mins (120.3km)</td>
                                    </tr>
                                    <tr>
                                        <td class="r-o">Route:</td>
                                        <td>via Davao - Buda National Hwy</td>
                                    </tr>
                                </tbody>
                            </table>
                            <a href="#" class="primary-btn">More Details</a>
