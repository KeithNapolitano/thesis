...
<body>
    <nav class="navbar navbar-light navbar-expand-md fixed-top navbar-shrink py-3" id="mainNav">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="index"><img src="{{ asset('import/assets/img/Logo.png')}}"></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            ...
            </div><button class="btn btn-primary" type="button">Register</button>
        </div>
    </nav>
    <section class="py-5 mt-5">
        <div class="container py-5">
            <h2 class="fw-bold text-center">Please Log in to Access the Operator Module</h2>
