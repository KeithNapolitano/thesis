...
<body>
    <nav class="navbar navbar-light navbar-expand-md py-3">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"></a><img src="{{ asset('import/assets/img/Logo.png')}}"><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-2"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
        ...
        <div class="row py-5">
            <div class="col-md-6 text-center text-md-start d-flex d-sm-flex d-md-flex justify-content-center align-items-center justify-content-md-start align-items-md-center justify-content-xl-end mb-4">
                <div style="max-width: 450px;">
                    ...
                    <p class="my-3">Make sure the entirety of the QR code is visible within the bounds of the camera. The status will be updated below.</p>
                    <form class="d-flex justify-content-center flex-wrap justify-content-md-start flex-lg-nowrap" method="post">
                        ...
                        <div class="my-2"></div>
                        <ul class="list-group">
                            <li class="list-group-item"><span><strong>Passenger Status:</strong></span><span id="output" style="margin-left: 9px;">Pending</span></li>
                        </ul>
                    </form>
                </div>
            </div>
            <div class="col-md-6 mb-4"><script src="{{ asset('import/assets/js/html5-qrcode.min.js')}}"></script>
                <div id="reader" width="600px">
                    <script>
                        ...
                        /* add output data here if approved */
                    </script>
