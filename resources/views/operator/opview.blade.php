...
<body>
    ...
    <div class="row mb-5" style="margin-top: 8px;margin-bottom: 50px;">
        <div class="col-md-8 col-xl-6 text-center mx-auto">
            ...
            echo "<h2 class=\"fs-2 fw-bold text-center\"><strong>Davao City to " . $matchingRoute->descr .
                    "</strong><br></h2>";
            } else {
                    ...
                    echo "<div class=\"col\">";
                        echo "<ul class=\"list-group\">";
                            echo "<li class=\"list-group-item\"><span><strong>Assigned
                                    ...
                                    "<br></span></li>";
                            echo "<li class=\"list-group-item\"><span><strong>Operator:&nbsp;</strong></span><span>" .
                                    $vanData->van_plate . "</span></li>";
                            echo "<li class=\"list-group-item\"><span><strong>Schedule:&nbsp;</strong>
                                </span><span>" . $vanData->dates . "</span></li>";
                            echo "</ul>";
                        echo "</div>";
                    echo "</div>";
                echo "</div>";
            ...
            echo "<h2 class=\"fs-2 fw-bold text-center\"><strong>Error:</strong> Missing van_plate parameter in URL.
            </h2>";
            echo "<div class=\"container\">";
                echo "<div class=\"row\">";
                    echo "<div class=\"col\">";
                        echo "<ul class=\"list-group\">";
                            echo "<li class=\"list-group-item text-danger\"><strong>Error:</strong> Missing van_plate
                                parameter in URL.</li>";
                            echo "</ul>";
                        echo "</div>";
                    echo "</div>";
                                ...
                                <form method="POST" id="trip-form"
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            ...
                                            <div>
                                                <input type="checkbox" id="driverstatus" name="driver_status" value="1"
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <div>
                                                <input type="checkbox" id="supervisorstatus" name="supervisor_status"
                                                    value="1" {{ $trip->supervisor_status == 1 ? 'checked' : '' }}>
                                            </div>
                                        </li>
                                    </ul>
